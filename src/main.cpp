...
int main()
{
    ...
    using namespace gl_render_application;

    gl_render_application::vertex_array_object vertexArrayObject(
            CreateScope<vertex_buffer_object<float>>(vertices),
            CreateScope<element_buffer_object<unsigned int>>(indices));
